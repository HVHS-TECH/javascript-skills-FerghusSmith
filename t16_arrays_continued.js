...
*/
function start(){
    OUTPUT.innerHTML = "<form onsubmit='return false;'><label for='formName'>possible outcomes: Mince, Fizzy drink, Carrot and Milk<br></label><input type='number' id='shoppingField' name='formshopping' placeholder='0-3'><input type='submit' onclick=getFormInput()></form>"
}
